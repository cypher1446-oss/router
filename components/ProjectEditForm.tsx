...
export default function ProjectEditForm({ project, clients }: ProjectEditFormProps) {
    const [formData, setFormData] = useState({
        ...
        token_prefix: project.token_prefix || '',
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="space-y-1">
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-indigo-500/5 focus:border-indigo-500/50 outline-none transition-all text-sm font-medium text-slate-700"
                                />
