                        ...
                        <div className="col-span-4 flex items-center space-x-6">
                            ...
                            <div>
                                <div className="flex items-center space-x-2">
                                    <h3 className="text-xl font-black text-slate-900 leading-tight">{project.project_code}</h3>
                                ...
                                <p className="text-xs text-slate-400 font-bold mt-1 uppercase tracking-wider">{project.client_name} <span className="mx-1">•</span> {project.country || 'Global'}</p>
                            </div>
                        </div>
